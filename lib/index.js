...
Argp.prototype._free = function (){
	this._debug = this._filename = this._debug = this._configuration =
			...
			this._options = this._optionsArray = this._optionsShort =
			this._optionsLong = this._usages = this._script = this._reWhitespace =
			this._ignore = this._ignoreFn = null;
};
...
Argp.prototype._newOption = function (o){
	...
	if (o.flag){
		...
		//Convert string to the type it represents
		if (o.value) o.value = cast (o.value);
	}
