...
Argp.prototype.allowUndefinedArguments = function (b){
	this._allowUndefinedArguments = b !== undefined ? b : true;
	return this;
};

Argp.prototype.allowUndefinedOptions = function (b){
	this._allowUndefinedOptions = b !== undefined ? b : true;
	return this;
};
...
Argp.prototype.sort = function (b){
	this._sort = b !== undefined ? b : true;
	return this;
};
