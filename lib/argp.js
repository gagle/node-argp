...
var Argp = module.exports = function (){
	...
	this._failBound = function (str, code){
		me.fail (str, code);
	};
};
...
Argp.prototype.command = function (name, o){
	if (this._commands[name]){
		throw ArgpError ("The command \"" + name + "\" is already defined");
	}
...
Argp.prototype.readPackage = function (p){
	try{
		...
		if (e instanceof SyntaxError) throw ArgpError ("JSON SyntaxError: " +
				e.message);
		if (p) throw ArgpError (e);
	}
