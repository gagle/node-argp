...
Argp.prototype._errorTry = function (){
	...
	if (this._showHelp && this._showUsage){
		str = "'" + script + " --help' or '" + script + " --usage'";
...
Argp.prototype.argv = function (){
	...
	//If it's a command, the command name is the first parameter
...
Argp.prototype.command = function (name, o){
	...
	var c = this._commandInstances[name] = new Command (this, o);
