...
var Argp = module.exports = function (){
	...
	this._printHelpBinded = function (){
		me._printHelp ();
	};
	this._printUsageBinded = function (){
		me._printUsage ();
	};
	this._printVersionBinded = function (){
		me._printVersion ();
	};
};
...
Argp.prototype.argv = function (input){
	...
	if (input){
		if (end) end (o, instance._printHelpBinded, instance._printUsageBinded,
				instance._printVersionBinded);
		return o;
	}
...
Argp.prototype.fail = function (str, code){
	...
	this._errorTry ();
	process.exit (code || this._exitStatus);
};
