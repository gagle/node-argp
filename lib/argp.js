...
Argp.prototype.printHelp = function (){
	var h = "";
	var prefix = "         ";
...
Argp.prototype.printUsage = function (){
	var usage = "";
	var prefix = "         ";
...
Argp.prototype.printVersion = function (){
...
Argp.prototype.readPackage = function (p){
	try{
		...
		if (e instanceof SyntaxError) throw new Error ("JSON SyntaxError: " +
				e.message);
