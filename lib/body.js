...
Body.prototype.argument = function (name, o){
	...
	if (this._command){
		Argp._validateTrailing (o.trailing);
	}
...
Body.prototype.line = function (str, prefix){
	this._argp._option ({
		line: str,
		prefix: prefix
	});
...
Body.prototype.option = function (o){
	...
	if (o.aliases){
		...
		o.aliases.forEach (function (alias){
			...
			for (var p in me._argp._optionsLong){
				if (p === alias){
...
Body.prototype.paragraph = function (str, prefix){
	this._argp._option ({
		paragraph: str,
		prefix: prefix
	});
...
Body.prototype.version = function (str){
	this._argp._packageVersion = false;
